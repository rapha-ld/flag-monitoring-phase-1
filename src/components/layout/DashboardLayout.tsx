...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="fixed left-0 top-0 h-full w-[61px] bg-white border-r border-border z-10">
        <img 
      ...
      <div className="fixed inset-0 pt-0 pb-0 pl-[61px] pr-[75px] overflow-y-auto">
        {children}
      </div>
      
      {/* Right Sidebar - fixed width navigation */}
      <div className="fixed right-0 top-0 h-full w-[75px] bg-white border-l border-border z-10">
        <img 
